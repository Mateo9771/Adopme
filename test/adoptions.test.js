...
//Configuración inicial: crear usuario y mascota antes de las pruebas
    before(async () => {
    ...
    //Crear una mascota para adoptar
    ...
    // Verificar que la mascota ahora está adoptada
    ...
    // Verificar que el usuario tiene la mascota adoptada
    const updatedUser = await usersService.getUserById(userId);
    console.log('updatedUser.pets (raw):', updatedUser.pets);
    console.log('petId:', petId);

    // Verificar si petId está presente en los strings de updatedUser.pets
    ...
    const nonExistentId = '66b1c2d3e4f5a6b7c8d9e0f1'; // ID inválido
