//RecursosBackend-Adoptme-main\RecursosBackend-Adoptme-main\src\controllers\sessions.controller.js
...
const logout = async(req, res) => {
    try {
        ...
        await usersService.updateUser(decoded._id, {last_connection: new Date()})
